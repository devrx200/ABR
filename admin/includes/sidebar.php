...
<div class="sidebar pe-4 pb-3 bg-warning">
    <nav class="navbar">
        ...
        <div class="navbar-nav w-100">
            ...
            <!-- <a href="../dash/gallery.php" class="nav-item nav-link mt-2 <?php  //($page_name == 'gallery.php') ? 'active' : ''; ?>"><i class="fas fa-image me-2"></i>Gallery-Page</a> -->
            ...
            <a href="../dash/menu.php" class="nav-item nav-link mt-2 <?= ($page_name == 'menu.php') ? 'active' : ''; ?>"><i class="fa-solid fa-menorah me-2"></i>Add-Menu</a>
            <!-- <a href="../dash/service.php" class="nav-item nav-link mt-2 <?php //($page_name == 'service.php') ? 'active' : ''; ?>"><i class="fas fa-tools me-2"></i>Service-Page</a> -->
            <!-- <a href="../dash/slider.php" class="nav-item nav-link mt-2 <?php //($page_name == 'slider.php') ? 'active' : ''; ?>"><i class="fas fa-sliders-h me-2"></i>Slider-Page</a> -->
             <!-- Reservations -->
             <a href="../dash/bookings.php" class="nav-item nav-link mt-2 <?= ($page_name == 'bookings.php') ? 'active' : ''; ?>"><i class="fa-regular fa-circle-question me-2"></i>Bookings</a> 
            ...
            <!-- Messages -->
            <a href="../dash/inbox.php" class="nav-item nav-link mt-2 <?= ($page_name == 'inbox.php') ? 'active' : ''; ?>"><i class="fa-solid fa-envelope-open-text me-2"></i>Inbox Query</a>
